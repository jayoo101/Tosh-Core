...
| **PM-E5** | 🟡 | Two of Q1's three criteria met as of §8.2 (2026-09-04): pause/unpause through a 2-of-3 Safe inside the window, and the status page carrying the announcement both ways. The third — a *new* signer participating — needs D4; the stand-in owners were a public test mnemonic on one laptop. Three of Step 4's four comms channels remain account signups. |
