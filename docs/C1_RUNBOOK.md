...
| Deployer | `0x4E41CEa950cF40FA59774B409988D6F9F399E690`, nonce 11 at the close of C1 and 12 now — the extra transaction is the orphan `pause()` in the row below. `0x73db078f…` remains the **testnet** deployer and §4.1 forbids reusing it |
