 ...
 * Auto-generated from compiled artifacts. Do not edit manually.
 */
...
export const FACTORY_ABI = [
  ...
  },
  {
    "inputs": [
      ...
      { "internalType": "address", "name": "_inflationReceiver", "type": "address" }
    ],
  ...
  {
    "inputs": [{ "internalType": "address", "name": "_newOp", "type": "address" }],
    "name": "setOperator",
    "outputs": [],
    "stateMutability": "nonpayable",
    "type": "function"
...
// MeritXFund — per-project contract ABI
export const FUND_ABI = [
  ...
  },
  {
    "anonymous": false,
    "inputs": [],
    "name": "PoolGriefDetected",
    "type": "event"
  },
  {
    "inputs": [],
    "name": "CALLER_REWARD_BPS",
    "outputs": [{ "internalType": "uint256", "name": "", "type": "uint256" }],
    "stateMutability": "view",
    "type": "function"
  },
  ...
  {
    "inputs": [
      { "internalType": "uint256", "name": "_maxAlloc", "type": "uint256" },
  ...
  },
  {
    "inputs": [],
    "name": "currentState",
    "outputs": [{ "internalType": "enum MeritXFund.State", "name": "", "type": "uint8" }],
    "stateMutability": "view",
    "type": "function"
  },
  {
    "inputs": [{ "internalType": "uint16", "name": "nextCardinality", "type": "uint16" }],
    "name": "expandPoolObservation",
    "outputs": [],
    "stateMutability": "nonpayable",
    "type": "function"
  },
  ...
  },
  {
    "inputs": [],
    "name": "projectToken",
    "outputs": [{ "internalType": "contract MeritXToken", "name": "", "type": "address" }],
    "stateMutability": "view",
    "type": "function"
  },
  {
