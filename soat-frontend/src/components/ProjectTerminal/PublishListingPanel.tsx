  ...
  return (
    ...
    >
      ...
      <div className="mt-gap flex flex-col gap-gap">
        ...
        {/* Only when the lookup did not answer, and the hint no longer says the
            chain does not have it — this cannot tell. The lookup is rate limited
            to six calls, it 503s when no endpoint will serve the log, and this
            state survives on a tab mounted before either was true, which is how
            a creator saw this field minutes after the lookup began answering.
            Naming one cause would be a guess printed as a diagnosis, and the
